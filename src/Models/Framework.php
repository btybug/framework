...
class Framework extends Model
{
    ...
    public static function activeCss()
    {
        ...
        return \Html::style('public/Framework/versions/' . $framework->version . '/css/main.css');
    }

    public static function customCss()
    {
        return \Html::style('public/Framework/custom.css');
    }

    public static function activeJs()
    {
        if(\File::exists(public_path('/Framework/main.js'))){
            return \Html::script('public/Framework/main.js?v='.time());
        }
        return null;
    }
