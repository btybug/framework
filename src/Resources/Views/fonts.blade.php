    ...
    <div class="row list_222">
        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
            <div class="tpl-list">
                        ...
                        <form class="form-horizontal">
                            <div class="form-group m-b-0  ">
                                ...
                                <select profile-id="11" data-sub="false" data-type="main-container"
                                    ...
                                    <option value="created_at.desc">Google Font</option>
                                    <option value="name.asc">Adobe Font</option>
                                    <option value="name.desc">Custom Font</option>
                                </select>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 p-l-0 p-r-0">
                        <div class="template-upload-button clearfix">
                            ...
                            <ul class="editIcons list-unstyled ">
                                ...
                                <li><a href="#" class="btn editBtn" data-toolaction="edit"><i
                ...
                <div class="container_main p-t-20">
