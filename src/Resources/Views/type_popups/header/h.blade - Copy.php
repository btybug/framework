                                                      ...
                                                      <div class="studio-collapse-toobar">
                                                          ...
                                                          <div class="editForm form-horizontal" data-exiting="studio">
															  ...
															  <div class="form-group">
																	<label for="var1" class="col-sm-2">@ Header</label>
																	<div class="input-group col-sm-3">
																	   <input type="text" class="form-control" id="var1" value="Variation 0001" aria-describedby="basic-addon2">
																	   <a href="#" data-studiosub="" class="input-group-addon btnRefresh" id="basic-addon2"><em class="iconRefreshRed"></em></a>
																	</div>
															  </div>
															  <div class="form-group">
																	<label for="var2" class="col-sm-2">@ Shadow</label>
																	<div class="input-group col-sm-3">
															  ...
															  <div class="form-group">
																	<label for="var3" class="col-sm-2">@ Animation</label>
																	<div class="input-group col-sm-3">
															  ...
															  <div class="form-group">
																	<label for="var4" class="col-sm-2">@ Color</label>
																	<div class="input-group col-sm-3">
