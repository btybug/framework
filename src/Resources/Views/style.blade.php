...
@section('tab')
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
            <div class="cms_module_list module_list_1">
                ...
                <ul class="list-unstyled menuList" id="components-list">
                    @if(View::exists("framework::sub_styles.$type"))
                        @include("framework::sub_styles.$type")
                    @endif
                </ul>
            </div>
        </div>
    ...
    <script type="template" data-template="existinglist">
        <div class="col-sm-4">
            <a href="#" class="thumbBox" data-actionexit="">
                <img src="{!! Html::image('app/Modules/Framework/Resources/Views/assets/framework/img/placeholder-img.jpg') !!}" alt="">
                <h4>{name}</h4></a>
        </div>
    </script>
...
@section('CSS')
    ...
    {!! HTML::style('/resources/assets/js/framework/frameworkstudio.css') !!}
@stop
@section('JS')
    ...
    {!! HTML::script('/resources/assets/js/framework/framework.js') !!}
    <script>
