...
?>
 <div class="row frameworkcontainer">
	<div class="col-xs-6">
        <div class="preview_area_anim">
            <div data-preview="studio" class="demo_container">
                Text Preview Here
            </div>
        </div>
	</div>
	<div class="col-xs-6 frameworkoptionbox animation-options">
	      <div class="row formrow form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-3" for="animationname"><span class="iconform arrowicon"></span> Animation Name</label>
                        <div class="col-sm-6">
                ...
                <div class="row formrow form-horizontal">
                    <div class="form-group">
                        <label for="animationduration" class="col-sm-3"><span class="iconform arrowicon"></span> Animation Duration</label>
                        <div class="col-sm-8">
                ...
                <div class="row formrow form-horizontal">
                    <div class="form-group">
                        <label for="animationdelay" class="col-sm-3"><span class="iconform arrowicon"></span> Animation Delay</label>
                        <div class="col-sm-8">
...
{!! HTML::script('app/Modules/Framework/Resources/Views/assets/framework/aniamtion-studio.js') !!}
@endpush