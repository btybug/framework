<!-- Modal -->
<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#fw-modal-{!!$name!!}">Open {!! $tag !!} Collections modal  Modal</button><input data-fw-button="{!!$name!!}" type="hidden" name="{!! $name !!}">
<div class="modal fade modal-fullscreen fullscreenModal" id="fw-modal-{!!$name!!}" role="dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <ul class="nav nav-tabs tabsmodal">
                    <li class="active"><a data-toggle="tab" href="#tab-1">Master Collections</a></li>
                    <li><a data-toggle="tab" href="#tab-2">Framework Collections</a></li>
                </ul>
            </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="container_main">
                                            ...
                                            <ul class="classes_list">
                                                @if($masterCollections)
                                                    @foreach($masterCollections as $className => $item)
                                                <li class="col-xs-12 col-sm-12 col-md-3 col-lg-3 " class-item="" class="close" data-dismiss="modal"   data-fw-name="{!! $name !!}" data-fw-value="{!! $className !!}" data-attr-name="t-color-black" data-classname="black">
                                        ...
                                        <div data-role="listitem">
                                            <ul class="classes_list">
                                                ...
                                                <li class="col-xs-12 col-sm-12 col-md-3 col-lg-3 " class-item="" class="close" data-dismiss="modal" data-fw-name="{!! $name !!}" data-fw-value="{!! $className !!}" data-attr-name="t-color-black" data-classname="black">
                                                    <div class="main_div_1" data-toolaction="selected" data-classname="black">
                                                        <div class="bottom_part_1" data-item="" data-key="true">
                                                            <a href="#"><span>{!! $item['display_name'] !!}</span></a>
                                                        </div>
                                                    </div>
                                                </li>
                                                    @endforeach
