@extends('layouts.mTabs',['index'=>'collection'])
@section('tab')
                                                ...
                                                <div class="layout clearfix">
                                                    ...
                                                    <div class="layoutData">
                                                        <div class="layoutCol p-r-0">
                                                            <div class="text_area col-xs-12 col-sm-4 col-md-4">
                                                                <div class="" data-toolaction="selected"
                                                                     data-classname="{!! $item['display_name'] !!}">
                                                                    <div class=" col-md-4" data-item="" data-key="true">
                                                                        <a href="#"
                                                            ...
                                                            <div class="col-xs-6 col-sm-4 col-md-4 text-right">
                                                                ...
                                                                <button data-element="{!! $type !!}" data-type="custom" data-key="{!! $className !!}" data-url="{!! url('/admin/framework/main-css/get-apply-classes', [$className, $type]) !!}"
                                                            ...
                                                            <div class="layoutFooter row">
                                                                ...
                                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4  centerText"><span class="iconRefresh"><i class="fa fa-refresh"></i></span>
                                                                </div>
...
//            $("a[main-type=" + p + "]").click();
            ...
            $('body').on('click', '.apply-classes-button', function() {
                ...
                $.ajax({
                    ...
                    console.debug($('#selected_collection_basket_modal').val());
                    $('#selected_collection_basket').val($('#selected_collection_basket_modal').val());
