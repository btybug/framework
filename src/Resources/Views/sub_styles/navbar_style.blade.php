<li class="@if($p=='general') active_class @endif">
    <a href="?type=navbar_style&amp;p=general" profile-id="11" main-type="general"
...
<li class="@if($p=='custom') active_class @endif">
    <a href="?type=navbar_style&amp;p=custom" profile-id="11" main-type="custom"
       rel="tab" class="tpl-left-items">
...
@foreach($colect_subs as $key=>$value)
    <li class="@if($p==$key) active_class @endif">
        <a href="?type=navbar_style&amp;p={!! $key !!}" profile-id="12" main-type="{!! $key !!}"
           rel="tab" class="tpl-left-items">
